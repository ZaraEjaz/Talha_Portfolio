  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="font-display font-bold text-[clamp(2.5rem,5vw,4rem)] leading-none uppercase text-foreground mb-4 max-w-4xl">
          Career <span className="text-accent">Journey</span>
        </h2>
        <p className="text-muted-foreground text-sm md:text-base max-w-sm">
          A timeline of my professional growth, from freelance foundations to enterprise engineering.
        </p>
      </div>
